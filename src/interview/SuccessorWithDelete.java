 ...
 * <p>
 * Solution: Use weighted union find data structure (by height rather then
 * size), add another array max[] to represent the largest element in a
 * connected component for that root. Each time we call successorWithDelete(x),
 * connect x and x+1 (N-1 is the special case), and returns the largest element
 * in the component which contains x.
 * 
 * @author Dongliang Yu
 * 
 */
